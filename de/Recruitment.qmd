...
plot_total <- plot_ly() %>%
  ...
  layout(
    title = "Rekrutierung über die Zeit",
    xaxis = list(title = "Datum", type = "date"),
    yaxis = list(title = "Anzahl Studienteilnehmende")
  )
...
p_intervention <- plot_ly() %>%
  ...
  add_trace(
    ...
    mode = "lines+markers",
    fill = "tozeroy",         # fill area down to y=0
    name = "Total Interventionsgruppe"
  ) %>%
  ...
  add_trace(
    ...
    mode = "lines+markers",
    fill = "tozeroy",
    name = "Total Uptake der Intervention"
  ) %>%
  layout(
    title = "Interventionsgruppe über die Zeit",
    xaxis = list(title = "Datum", type = "date"),
    yaxis = list(title = "Anzahl Studienteilnehmende")
  )
